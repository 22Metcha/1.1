...
def main():    
    ...
    monthly_investment_entry = tk.StringVar()
    yearly_interest_rate_entry = tk.StringVar()
    years_entry = tk.StringVar()
    future_value_label = tk.StringVar()
    ...
    tk.Label(frame, text="Monthly Investment:").grid(column=0, row=0, sticky=E)
    monthly_investment_field = tk.Entry(frame, width=25,
                                         textvariable=monthly_investment_entry)
    monthly_investment_field.grid(column=1, row=0)

    tk.Label(frame, text="Yearly Interest Rate:").grid(column=0, row=1,
                                                        sticky=E)
    tk.Entry(frame, width=25, textvariable=yearly_interest_rate_entry).grid(
        column=1, row=1)

    tk.Label(frame, text="Years:").grid(column=0, row=2, sticky=E)
    tk.Entry(frame, width=25, textvariable=years_entry).grid(
        column=1, row=2)

    tk.Label(frame, text="Future Value:").grid(column=0, row=3, sticky=E)
    tk.Entry(frame, width=25, textvariable=future_value_label,
              state="readonly").grid(
                  column=1, row=3)
    ...
    tk.Button(button_frame, text="Calculate", command=cb,
